      ...
      <div className="sticky top-24">
        ...
        <div className="mt-[24px]">
          ...
          <p className="mt-[16px] text-[18px] leading-[28px] flex items-center gap-2">
            ...
            Người dịch: <a href={translatorUrl} className="font-semibold text-[rgb(192,_132,_252)]">{translator}</a>
          </p>
          <p className="mt-[16px] text-[18px] leading-[28px] flex items-center gap-2">
          ...
          <div className="mt-[16px] text-[18px] leading-[28px] flex items-center gap-2">
            ...
            Trạng thái: <div className="items-center border inline-flex font-semibold bg-[rgb(39,_71,_53)] border-black/0 text-[rgb(122,_213,_195)] text-[14px] leading-[20px] pt-[2px] pr-[10px] pb-[2px] pl-[10px] rounded-[624.9375rem]">{status}</div>
          </div>
          <p className="mt-[16px] text-[18px] leading-[28px] flex items-center gap-2">
          ...
          <div className="flex mt-[16px]">
            <div className="items-center flex flex-wrap overflow-hidden mb-[24px] text-[18px] gap-[8px] leading-[28px]">
              ...
              Thể loại<div className="items-center border flex font-semibold bg-[rgb(58,_59,_60)] border-neutral-800 text-[14px] leading-[20px] pt-[2px] pr-[10px] pb-[2px] pl-[10px] rounded-[624.9375rem]">{genre}</div>
            </div>
          </div>
        </div>
      </div>
