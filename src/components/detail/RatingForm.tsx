  ...
  return (
    <div className="ml-auto mr-auto mb-[48px] max-w-sm">
      ...
      <div className="border bg-[rgb(10,10,10)] border-neutral-800 shadow-2xl p-6 rounded-lg">
        ...
        <div className="flex mb-[4px] gap-[4px]">
          {[1, 2, 3, 4, 5].map((star) => (
            <svg
              ...
              viewBox="0 0 24 24"
              fill={star <= displayScore ? "rgb(250,204,21)" : "none"}
              stroke={star <= displayScore ? "rgb(250,204,21)" : "currentColor"}
              strokeWidth="2"
              className="w-7 h-7 cursor-pointer transition-all text-gray-500 hover:scale-110"
        ...
        <p className="text-xs text-gray-500 mb-[16px] h-4">
        ...
        <textarea
          ...
          className="flex overflow-auto resize-none whitespace-pre-wrap w-full bg-[rgb(20,20,20)] text-gray-200 text-[14px] leading-[20px] min-h-20 pt-2 pr-3 pb-2 pl-3 rounded-md border border-neutral-800 focus:border-yellow-400 focus:outline-none transition-colors mb-4"
        />
        ...
        <button
          ...
          className="w-full bg-yellow-400 hover:bg-yellow-300 disabled:opacity-50 disabled:cursor-not-allowed text-black font-bold py-2.5 rounded-lg transition-colors text-sm"
        >
