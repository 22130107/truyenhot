    ...
    <header className="fixed left-0 top-0 right-0 bg-black/90 backdrop-blur-md border-b border-neutral-800 z-[50] py-1">
      <div className="w-full px-4 lg:px-8">
        <div className="items-center flex justify-between">
          ...
          {/* Chapter info */}
          <div className="flex items-center text-white text-[12px] md:text-[15px] font-medium bg-white/5 px-3 md:px-4 py-1.5 rounded-full border border-white/10 mx-2 overflow-hidden">
            <span className="text-[rgb(250,204,21)] shrink-0">Chương {chapterNumber}</span>
            <span className="hidden md:inline mx-3 text-gray-600">|</span>
            <span className="hidden md:inline text-gray-300 truncate max-w-[200px] lg:max-w-[300px]">{chapterTitle}</span>
          </div>
          ...
          <div className="items-center flex gap-1 md:gap-2">
            ...
            <button
              ...
              className="p-1.5 md:p-2 text-gray-300 hover:text-[rgb(250,204,21)] transition-all"
            >
            ...
            <button
              ...
              className={`hidden sm:block p-1.5 md:p-2 transition-all disabled:opacity-50 ${liked ? "text-red-500" : "text-gray-300 hover:text-red-500"}`}
            >
            ...
            <div className="relative">
              <button
                ...
                className={`p-1.5 md:p-2 transition-all ${userRating ? "text-yellow-400" : "text-gray-300 hover:text-yellow-400"}`}
              >
              ...
              {showRating && (
                <div className="absolute top-full right-0 mt-2 bg-[rgb(36,37,38)] border border-neutral-700 rounded-xl shadow-2xl p-3 z-50">
                  <p className="text-xs text-gray-400 mb-2 text-center whitespace-nowrap">
                    ...
                    {[1, 2, 3, 4, 5].map((star) => (
                      <button
                        ...
                        className={`p-1 transition-all disabled:opacity-50 ${
                          userRating && star <= userRating ? "text-yellow-400" : "text-gray-500 hover:text-yellow-400"
                        }`}
                      >
            ...
            <button
              ...
              className={`p-1.5 md:p-2 transition-all disabled:opacity-50 ${bookmarked ? "text-blue-400" : "text-gray-300 hover:text-blue-400"}`}
            >
