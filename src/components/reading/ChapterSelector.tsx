      ...
      <div className="flex items-center justify-center gap-2">
        ...
        {prevChapter ? (
          <Link href={`/novel/${id}/${prevChapter}`}>
            <button className="items-center inline-flex font-medium justify-center h-10 bg-[rgb(208,203,203)] text-neutral-900 text-[13px] md:text-[14px] gap-2 px-3 md:px-4 rounded-md hover:bg-white transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                <path fillRule="evenodd" d="M12.79 5.23a.75.75 0 01-.02 1.06L8.832 10l3.938 3.71a.75.75 0 11-1.04 1.08l-4.25-4a.75.75 0 010-1.08l4.25-4a.75.75 0 011.06.02z" clipRule="evenodd" />
              </svg>
              Chương trước
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="items-center border flex justify-between w-40 md:w-48 h-10 bg-[rgb(36,37,38)] border-neutral-800 text-[13px] md:text-[14px] px-3 md:px-4 rounded-md hover:border-[rgb(250,204,21)] transition-colors"
          >
          ...
          {isOpen && (
            <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 w-64 bg-[rgb(36,37,38)] border border-neutral-700 rounded-xl shadow-2xl z-50 overflow-hidden">
              {loading ? (
                <div className="py-6 text-center text-sm text-gray-400">Đang tải...</div>
              ) : chapters.length === 0 ? (
                <div className="py-6 text-center text-sm text-gray-400">Không có chương</div>
              ) : (
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-4 py-2.5 text-left text-[13px] transition-colors
                          ${isActive
                            ? 'bg-[rgb(250,204,21)]/10 text-[rgb(250,204,21)] font-semibold'
