  ...
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-8 pt-28 pb-20">
      <div className="flex items-baseline gap-4 mb-8">
        ...
        {!loading && <span className="text-gray-500 text-sm">{total} kết quả</span>}
      </div>
      ...
      <div className="space-y-4 mb-10">
        ...
        >
          <input
            ...
            className="w-full bg-black border border-neutral-800 p-4 pl-12 pr-28 rounded-xl focus:outline-none focus:border-yellow-400 transition-all text-white"
          />
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-gray-500">
