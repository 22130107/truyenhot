      ...
      <main className="pt-24 pb-16 px-4 md:px-8 max-w-[1920px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          ...
          <div className="flex items-center gap-2 bg-yellow-500/10 px-4 py-2 rounded-full border border-yellow-500/20">
            ...
            <span className="text-gray-300 text-sm">
              Số xu hiện có:{" "}
              <span className="text-yellow-500 font-bold">{userCoins} xu</span>
            </span>
          </div>
        </div>
        ...
        {(status === "pending" || status === "completed" || status === "failed" || status === "cancelled") && paymentInfo && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
            <div className="bg-[rgb(31,41,55)] border border-neutral-700 rounded-2xl p-6 w-full max-w-md shadow-2xl">
              ...
              {status === "pending" && (
                <>
                  ...
                  <div className="bg-neutral-800/60 rounded-xl p-4 space-y-2 text-sm mb-4">
                  ...
                  {/* Cảnh báo nội dung */}
                  <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg px-3 py-2 text-xs text-yellow-300 mb-4">
                    ⚠️ Nhập <strong>đúng nội dung chuyển khoản</strong> để hệ thống tự động xác nhận.
                  </div>

                  {/* Đếm ngược */}
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-400">Hết hạn sau</span>
              ...
              {status === "completed" && (
                <div className="text-center py-4">
                  ...
                  <p className="text-gray-300 text-sm mb-1">
                    Bạn đã nhận được <span className="text-yellow-400 font-bold">{paymentInfo.coins} xu</span>
                  </p>
                  <p className="text-gray-400 text-xs mb-6">Xu đã được cộng vào tài khoản của bạn.</p>
                  <button
              ...
              {status === "failed" && (
                <div className="text-center py-4">
                  ...
                  <p className="text-gray-400 text-sm mb-6">Số tiền không khớp hoặc có lỗi xảy ra.</p>
                  <button onClick={handleCancel} className="bg-neutral-700 hover:bg-neutral-600 text-white font-bold px-6 py-2.5 rounded-xl transition-all">
                    Thử lại
                  </button>
                </div>
              )}
              ...
              {status === "cancelled" && (
                <div className="text-center py-4">
                  ...
                  <h2 className="text-xl font-bold text-gray-300 mb-2">Đơn đã hết hạn</h2>
                  <p className="text-gray-400 text-sm mb-6">Vui lòng tạo đơn mới để tiếp tục.</p>
                  <button onClick={handleCancel} className="bg-neutral-700 hover:bg-neutral-600 text-white font-bold px-6 py-2.5 rounded-xl transition-all">
                    Đóng
                  </button>
                </div>
            ...
            >
              ...
              <div className="mb-6">
                <p className="text-gray-400 text-xs mb-1">
                  Nhận <span className="text-yellow-500 font-bold">{pkg.coins} xu</span>
                </p>
        ...
        <div className="bg-[rgb(31,41,55)] border border-neutral-800 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-gray-300 text-sm leading-relaxed pt-1.5">Chụp màn hình đã follow</p>
            </div>
            <div className="flex items-start gap-4">
            ...
            <div className="mt-8 pt-8 border-t border-neutral-700/50 space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-sm text-gray-400">
                  ...
                  <span className="text-yellow-500 font-bold ml-1">5 xu</span>
                </li>
                <li className="flex items-center gap-3 text-sm text-gray-400">
                  <div className="w-1.5 h-1.5 rounded-full bg-yellow-500"></div>
                  Mỗi email chỉ nhận được tối đa{" "}
                  <span className="text-yellow-500 font-bold mx-1">10 xu</span> cho nhiệm vụ này
                </li>
                <li className="flex items-center gap-3 text-sm text-gray-400">
                  <div className="w-1.5 h-1.5 rounded-full bg-yellow-500"></div>
