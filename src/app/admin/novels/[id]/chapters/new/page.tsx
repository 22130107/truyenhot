...
export default function AdminAddChapterPage() {
  ...
  const handleSaveChapter = async () => {
    if (!title || !content || chapterNumber === "") {
      alert("Vui lòng nhập Tên chương, Số chương và Nội dung!");
      return;
    }
      ...
      <div className="bg-[#111] border border-neutral-800 rounded-2xl p-6 md:p-8">
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-neutral-400">Tên chương <span className="text-red-500">*</span></label>
              <input 
                type="text" 
